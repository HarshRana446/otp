        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-purple-600 text-white py-3 rounded-lg font-semibold hover:bg-purple-700 transition flex items-center justify-center group shadow-lg hover:shadow-xl"
            >
              Create Account
